...
import helper.misc.UnsafeHelper;
...
public class ReflectionHelper {
	...
	public static <T> Optional<T> instance(Class<T> cls) {
		...
		try {
			return Optional.of(cls.cast(UnsafeHelper.instance().orElseThrow().allocateInstance(cls)));
	...
	public static String methodName() {
		return StackWalker.getInstance(StackWalker.Option.RETAIN_CLASS_REFERENCE) //
				.walk(frame -> frame.skip(1).findFirst()).orElseThrow() //
				.getMethodName();
	}
	...
	public static Object callForbiddenMethod(String clsPath, String methodName, Object... params)
		...
		var method = params.length > 0 ? cls.getMethod(methodName, map(params, Object::getClass, Class[]::new)) : cls.getMethod(methodName);
